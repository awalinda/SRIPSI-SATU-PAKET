        ...
        child: Stack(
          ...
          Center(
            child: SingleChildScrollView(
              padding: EdgeInsets.symmetric(horizontal: 20, vertical: isDesktop ? 20 : 10),
              child: ClipRRect(
                                  ...
                                  try {
                                    ...
                                    if (userCredential != null) {
                                      ...
                                      if (user != null && context.mounted) {
                                        // 🔒 Cek Verifikasi Email (Kecuali untuk Admin default)
                                        if (!user.emailVerified && user.email != 'admin@gmail.com') {
                                          CustomNotification.showError(context, "Harap verifikasi email Anda terlebih dahulu.");
                                        ...
                                        if (context.mounted) {
                                          if (role == "admin") {
                                            CustomNotification.showSuccess(context, "Selamat datang, Admin!");
                                    ...
                                    if (context.mounted) {
                                      ...
                                      setState(() => _passwordError = AuthService.getErrorMessage(e));
                                    }
                                  } finally {
